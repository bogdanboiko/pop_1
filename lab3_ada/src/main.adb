...
procedure Main is
   ...
   procedure Starter (Storage_Size : in Integer; Item_Numbers : in Integer) is
      ...
      producer_quantity: Integer := 5;
      consumer_quantity: Integer := 7;
   ...
   begin
      ...
      Put_Line ("Items per producer" & producer_step'img);
      Put_Line ("Items per consumer" & consumer_step'img);
        for i in 1.. producer_quantity loop
           Put_Line ("Started producer " & i'img);
        ...
        for i in 1.. consumer_quantity loop
           Put_Line ("Started consumers " & i'img);
